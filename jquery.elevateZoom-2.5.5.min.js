	...
	var ElevateZoom = {
			...
			setWindowPostition: function( e ) {
				...
				if(self.Eboppos){
					...
					else{self.windowTopPos = (self.largeHeight/self.options.zoomLevel-self.zoomWindow.height())*(-1);}
				}
				if(self.Eroppos){
					if(self.options.changed){self.windowLeftPos = ((self.largeWidth-self.zoomWindow.width())*(-1));}
					else{self.windowLeftPos = ((self.largeWidth/self.options.zoomLevel-self.zoomWindow.width())*(-1));}
				}
			...
			swaptheimage: function(smallimage, largeimage){
				...
				newImg.onload = function() {
					self.largeWidth = newImg.width/self.options.zoomLevel;
					self.largeHeight = newImg.height/self.options.zoomLevel;
